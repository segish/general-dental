...
(3, 'laboratory_center_name', 'eMarket', NULL, NULL),
...
CREATE TABLE `currencies` (
  ...
  `exchange_rate` decimal(24,2) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
  ...
  `extra_discount` decimal(24,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `order_details` (
  ...
  `discount_on_product` decimal(24,2) DEFAULT NULL,
