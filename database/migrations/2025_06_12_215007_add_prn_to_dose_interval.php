...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE prescription_details MODIFY COLUMN dose_interval ENUM('Once Daily', 'Twice Daily', 'Three Times Daily', 'Every 6 Hours', 'Every 8 Hours') DEFAULT 'Once Daily'");
    }
};
