...
class AppointmentStatusUpdate extends Mailable
{
    ...
    {
        return $this->view('email-templates.notify-status-change', 
        ['appointment' => $this->appointment, 'patient' => $this->patient, 
        'doctor' => $this->doctor, 'appointment_slot'=>$this->appointment_slot])->subject('Appointment Status  Change Notification'); ; ;
    }
