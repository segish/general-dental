...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'checkAdminPermission' => \App\Http\Middleware\CheckAdminPermissionMiddleware::class,
        'checkBranchPermission' => \App\Http\Middleware\CheckBranchPermissionMiddleware::class,
