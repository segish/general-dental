...
@section('title', translate('update nurse'))
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{ asset(config('app.asset_path') . '/admin/img/icons/product.png') }}"
                    alt="">
                {{ \App\CentralLogics\translate('update_nurse') }}
            </h2>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form
                    action="{{ isset($nurse) ? route('admin.nurse.update', ['id' => $nurse->id]) : route('admin.nurse.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="f_name"
                                                value="{{ isset($nurse) ? $nurse->admin->f_name : '' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="l_name"
                                                value="{{ isset($nurse) ? $nurse->admin->l_name : '' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone"
                                                value="{{ isset($nurse) ? $nurse->admin->phone : '' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email"
                                                value="{{ isset($nurse) ? $nurse->admin->email : '' }}"
                                                class="form-control"
                                            ...
                                            <select name="roles[]" class="form-control js-select2-custom" multiple required>
                                                @foreach ($roles as $role)
                                                    <option value="{{ $role->name }}"
                                                        {{ in_array($role->name, $nurse->admin->roles->pluck('name')->toArray()) ? 'selected' : '' }}>
                                                        {{ $role->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="experience"
                                                value="{{ isset($nurse) ? $nurse->experience : '' }}" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" class="form-control js-select2-custom" required>
                                                <option value="male" {{ $nurse->gender == 'male' ? 'selected' : '' }}>
                                                    Male
                                                </option>
                                                <option value="female" {{ $nurse->gender == 'female' ? 'selected' : '' }}>
                                                    Female
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="department_id" class="form-control js-select2-custom" required>
                                                ...
                                                @foreach ($departments as $dep)
                                                    <option value="{{ $dep->id }}"
                                                        {{ isset($nurse) && $nurse->department_id == $dep->id ? 'selected' : '' }}>
                                                        {{ $dep->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <textarea name="about" class="ckeditor form-control">{{ isset($nurse) ? $nurse->about : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="upload-file">
                                                    ...
                                                    <div class="upload-file__img">
                                                        <img width="150" id="viewer"
                                                            src="{{ $nurse->getImageUrl() }}"
                                                            alt="{{ $nurse->admin->f_name }} Image">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
