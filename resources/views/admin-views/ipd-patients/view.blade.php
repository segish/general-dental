                ...
                <div class="row gy-3">
                    <div class="col-md-5">
                        <div class="media gap-4 align-items-center">
                            ...
                            <div class="media-body">
                                ...
                                <p> {{ \App\CentralLogics\translate('of') }} {{ $product->reviews->count() }}
                    ...
                    <div class="col-md-7">
                        <ul class="list-unstyled list-unstyled-py-3 mb-0">
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="mr-3">{{ translate('5 star') }}</span>
                    ...
                    <div class="col-md-6 col-lg-4 text-dark">
                        ...
                        <div>
                            ...
                            <span>{{ Helpers::set_symbol($product['price']) }} /
                                {{ \App\CentralLogics\translate('' . $product['unit']) }}</span>
                        </div>
                        ...
                        <div class="d-flex flex-column gap-1 fs-12">
                            @foreach (json_decode($product['variations'], true) as $variation)
                                <div class="text-capitalize">
                                    {{ $variation['type'] }} : {{ Helpers::set_symbol($variation['price']) }} ( Stock :
                                    {{ $variation['stock'] ?? 0 }} )
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="col-md-6 col-lg-8">
                        <div class="border-md-left pl-md-4 h-100">
                            <h4>{{ \App\CentralLogics\translate('short') }}
                                {{ \App\CentralLogics\translate('description') }} : </h4>
