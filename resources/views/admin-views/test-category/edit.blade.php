...
@section('title', translate('Update Test Category'))
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{ asset(config('app.asset_path') . '/admin/img/icons/product.png') }}"
                    alt="">
                {{ \App\CentralLogics\translate('Update Test Category') }}
            </h2>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.test_category.update', $testCategory->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <textarea name="description" class="ckeditor form-control">{{ $testCategory->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
