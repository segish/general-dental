                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" class="form-control js-select2-custom" required>
                                                <option value={{ $patient->gender }} selected disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="blood_group" class="form-control js-select2-custom">
                                                <option value="" disabled>
                                                    {{ \App\CentralLogics\translate('blood_group') }}
                                                </option>
                                                <option value="A+"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="marital_status" class="form-control js-select2-custom">
                                                <option value="" disabled>
                                                    {{ \App\CentralLogics\translate('Select_marital_status') }}
                                                </option>
                                                <option value="single"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="is_flexible_payment" class="form-control js-select2-custom"
                                                ...
                                                <option value="1"
                                                    {{ $patient->is_flexible_payment == '1' ? 'selected' : '' }}>Yes
                                                </option>
                                                <option value="0"
                                                    {{ $patient->is_flexible_payment == '0' ? 'selected' : '' }}>No
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="input-label"
                                                for="email">{{ \App\CentralLogics\translate('TIN No.') }}</label>
                                            <input type="text" name="tin_no" class="form-control"
                                                value="{{ $patient->tin_no }}">
                                        </div>
                                    </div>
