...
@section('title', translate('patients List'))
...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-3 align-items-center mb-3">
            ...
            <span class="badge badge-soft-dark rounded-50 fs-14">{{ $patients->total() }}</span>
        </div>
                                ...
                                @foreach ($patients as $key => $patient)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.patient.delete', [$patient['id']]) }}"
