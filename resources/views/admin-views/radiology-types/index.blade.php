...
@section('title', translate('add_new_radiology'))
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.radiology.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ \App\CentralLogics\translate('Radiology Name') }}<span
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ \App\CentralLogics\translate('Title') }}<span
                                                class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" name="title" class="form-control"
                                            placeholder="{{ translate('Title Name for the radiology') }}" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="time_taken_hour" class="form-control"
                                            placeholder="{{ translate('Enter time taken') }}" required min="0"
                                            step="1">
                                    </div>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="input-label">{{ translate('Is Inhouse') }}<span
                                                class="input-label-secondary text-danger">*</span></label>
                                        <select name="is_inhouse" id="is_inhouse" class="form-control js-select2-custom"
                                            required>
                                            <option value="" selected disabled>
                                                {{ \App\CentralLogics\translate('Select inhouse status') }}
                                            </option>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="input-label">{{ translate('Is Active') }}<span
                                                class="input-label-secondary text-danger">*</span></label>
                                        <select name="is_active" id="is_active" class="form-control js-select2-custom"
                                            required>
                                            <option value="" selected disabled>
                                                {{ \App\CentralLogics\translate('Select active status') }}
                                            </option>
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                        </select>
