...
@section('title', translate('Disease Report'))
@push('css_or_js')
    <meta name="csrf-token" content="{{ csrf_token() }}">
@endpush
@section('content')
    <div class="container py-4">
        <h2 class="mb-4">Disease Report ({{ $startDate->toDateString() }} - {{ $endDate->toDateString() }})</h2>
    ...
    <div class="card mb-3">
        <div class="row g-2" id="order_stats">
            ...
            <!-- Card for Unique Diseases Diagnosed -->
            <div class="col-sm-3">
                <div class="dashboard--card">
                    <h5 class="dashboard--card__subtitle">
                        {{ \App\CentralLogics\translate('Unique Diseases Diagnosed') }}
                    </h5>
            ...
            <!-- Card for OPD Visits with Diseases -->
            <div class="col-sm-3">
                <div class="dashboard--card">
                    <h5 class="dashboard--card__subtitle">
                        {{ \App\CentralLogics\translate('OPD Visits with Diseases') }}
                    </h5>
                    <h2 class="dashboard--card__title">
            ...
            <!-- Card for IPD Visits with Diseases -->
            <div class="col-sm-3">
                <div class="dashboard--card">
                    <h5 class="dashboard--card__subtitle">
                        {{ \App\CentralLogics\translate('IPD Visits with Diseases') }}
                    </h5>
                    <h2 class="dashboard--card__title">
            ...
            <!-- Card for Total Visits with Diseases -->
            <div class="col-sm-3">
                <div class="dashboard--card">
                    <h5 class="dashboard--card__subtitle">
                        {{ \App\CentralLogics\translate('Total Visits with Diseases') }}
                    </h5>
                    <h2 class="dashboard--card__title">
