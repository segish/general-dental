...
<div class="row" id="printableArea" style="margin: auto;">
    <div style="width:410px;">
        ...
        <div class="row mt-3">
            <div class="col-6">
                <h5>{{\App\CentralLogics\translate('Reg No')}} : {{$billing->patient['registration_no']}}</h5>
            </div>
            <div class="col-6">
            ...
            @if($billing->patient)
                <div class="col-6">
                    <h5>{{$billing->patient['full_name']}}</h5>

                </div>
                <div class="col-6">
                    <h5>{{$billing->patient['phone']}}</h5>
        ...
        <table class="table table-bordered mt-3 text-dark">
            <thead>
                <tr>
                    <th class="border-bottom-0">{{\App\CentralLogics\translate('Service Name')}}</th>
            ...
            @foreach($billing->billingDetails as $detail)
                    <tr>
                        <td class="">
                            <div class="mb-1"> {{ Str::limit($detail->service['service_name'], 200) }}</div>
                        </td>
                        <td class="">
