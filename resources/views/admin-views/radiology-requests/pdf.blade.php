        ...
        <table class="tests-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 30%;">Radiology Name</th>
                    <th style="width: 10%;">Remarks</th>
                </tr>
            </thead>
            <tbody>
                @php $counter = 1; @endphp
                @foreach ($visit->radiologyRequest->radiologies as $radiologyRequestRadiology)
                    @if (!$radiologyRequestRadiology->radiology->is_active)
                        <tr>
                            <td>{{ $counter++ }}</td>
                            <td>{{ $radiologyRequestRadiology->radiology->radiology_name }}</td>
                            <td></td>
                        </tr>
                    @endif
                @endforeach
            ...
            <tr>
                <td>
                    <div class="signature-line">
                        Requested By: {{ $visit->radiologyRequest->collector->full_name }}<br>
                        Qualification: {{ $visit->radiologyRequest->collector->department->name }}<br>
                        @if ($visit->radiologyRequest->collector->signature)
                            <img src="{{ $visit->radiologyRequest->collector->signature_url }}"
