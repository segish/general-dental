...
@section('title', translate('Add New Specimen Source'))
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.specimen_origin.store') }}" method="post"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="{{ translate('Enter specimen source') }}" required>
                                    </div>
