    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.business-settings.update-social-media-chat') }}" method="post"
                                        ...
                                        <div class="card-body form-group">
                                            <label class="toggle-switch d-flex align-items-center mb-3"
                                                ...
                                                <span class="toggle-switch-content ml-0">
                                                    <span
                                                        class="d-block font-weight-bold">{{ translate('whatsapp') }}</span>
                                                </span>
                                                <input type="checkbox" name="whatsapp_status" class="toggle-switch-input"
                                                    value="1" id="whatsapp_status"
                                                    {{ $whatsapp_data['status'] == 1 ? 'checked' : '' }}>
                                                <span class="toggle-switch-label">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                            <label class="text-capitalize" class="form-label">{{ translate('Number') }}<span
                                                    class="text-danger">
                                                    ({{ translate('without country code') }})</span></label>
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body form-group">
                                            <label class="toggle-switch d-flex align-items-center mb-3"
                                                ...
                                                <span class="toggle-switch-content ml-0">
                                                    <span
                                                        class="d-block font-weight-bold">{{ translate('telegram') }}</span>
                                                </span>
                                                <input type="checkbox" name="telegram_status" class="toggle-switch-input"
                                                    value="1" id="telegram_status"
                                                    {{ $telegram_data['status'] == 1 ? 'checked' : '' }}>
                                                <span class="toggle-switch-label">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                            <label class="text-capitalize"
                                                class="form-label">{{ translate('User Name') }}<span class="text-danger">
                                                    ({{ translate('without @') }})</span></label>
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body form-group">
                                            <label class="toggle-switch d-flex align-items-center mb-3"
                                                ...
                                                <span class="toggle-switch-content ml-0">
                                                    <span
                                                        class="d-block font-weight-bold">{{ translate('messenger') }}</span>
                                                </span>
                                                <input type="checkbox" name="messenger_status" class="toggle-switch-input"
                                                    value="1" id="messenger_status"
                                                    {{ $messenger_data['status'] == 1 ? 'checked' : '' }}>
                                                <span class="toggle-switch-label">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                            <label class="text-capitalize"
                                                class="form-label">{{ translate('User Name') }}</label>
