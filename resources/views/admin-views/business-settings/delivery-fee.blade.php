                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="d-flex gap-2 align-items-center my-2">
                                ...
                                <label for="shipping_by_distance_status"
                                    class="text-dark font-weight-bold mb-0">{{ \App\CentralLogics\translate('delivery_charge_by_distance') }}</label>
                            </div>

                            <div class="form-group">
                                <div class="form-group pl-3">
                                    <label>{{ \App\CentralLogics\translate('Minimum delivery Charge') }} </label><br>
                                    <input type="number" step=".01" class="form-control" name="min_shipping_charge"
                                        value="{{ $config['min_shipping_charge'] }}" id="min_shipping_charge"
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="d-flex gap-2 align-items-center my-2">
                                    ...
                                    <label for="default_delivery_status"
                                        class="text-dark font-weight-bold mb-0">{{ \App\CentralLogics\translate('default_delivery_charge') }}</label>
                                </div>
                                <div class="form-group pl-3">
                                    @php($delivery = \App\Models\BusinessSetting::where('key', 'delivery_charge')->first()->value)
                                    <div class="form-group pl-3">
                                        <label
                                            for="exampleFormControlInput1">{{ \App\CentralLogics\translate('Delivery Charge') }}
                                        </label>
                                        <input type="number" min="0" step=".01" name="delivery_charge"
                                            value="{{ $delivery }}" class="form-control"
