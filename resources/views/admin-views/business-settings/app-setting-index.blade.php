                        ...
                        <form
                            ...
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <label class="text-dark font-weight-bold mb-0"
                                    for="play_store_status">{{ translate('Enable download link for web footer') }}</label>
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input" id="play_store_status"
                                        name="play_store_status" value="1"
                            ...
                            <div class="mb-4">
                                <label class="text-dark" for="app_store_link">{{ translate('Download link') }}
                                </label>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" min="0" step=".1" id="android_min_version"
                                    name="android_min_version" value="{{ $config['min_version'] ?? '' }}"
                                    class="form-control" placeholder="{{ translate('EX: 4.0') }}">
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <label class="text-dark font-weight-bold mb-0"
                                    for="app_store_status2">{{ translate('Enable download link for web footer') }}</label>
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input" id="app_store_status2"
                                        name="app_store_status" value="1"
                                        {{ isset($config) && $config['status'] == 1 ? 'checked' : '' }}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" min="0" step=".1" id="ios_min_version"
                                    name="ios_min_version" value="{{ $config['min_version'] ?? '' }}" class="form-control"
