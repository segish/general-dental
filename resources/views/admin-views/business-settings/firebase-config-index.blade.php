...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form
                    action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.firebase_message_config') : 'javascript:' }}"
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="apiKey"
                                        value="{{ env('APP_MODE') != 'demo' ? $data['apiKey'] : '' }}" required
                                        autocomplete="off">
                                </div>
                            </div>
                            <div class="col-xl-4 col-sm-6">
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="projectId"
                                        value="{{ env('APP_MODE') != 'demo' ? $data['projectId'] : '' }}" required
                                        autocomplete="off">
                                </div>
                            </div>
                            <div class="col-xl-4 col-sm-6">
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="appId"
                                        value="{{ env('APP_MODE') != 'demo' ? $data['appId'] : '' }}" required
                                        autocomplete="off">
                                </div>
                            </div>
                            <div class="col-12">
