                ...
                <form action="{{ route('admin.business-settings.update-otp') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="input-label"
                                    for="maximum_otp_hit">{{ \App\CentralLogics\translate('maximum_OTP_submit_attempt') }}
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="input-label"
                                    for="otp_resend_time">{{ \App\CentralLogics\translate('OTP_resend_time') }}
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="input-label"
                                    for="temporary_block_time">{{ \App\CentralLogics\translate('temporary_OTP_block_time') }}
                                    <span class="text-danger">( {{ translate('in second') }} )</span>
                                    <i class="tio-info-outined" data-toggle="tooltip" data-placement="top"
