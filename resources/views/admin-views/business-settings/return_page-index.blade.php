            ...
            <div class="card-body">
                <form action="{{ route('admin.business-settings.return_page_update') }}" id="tnc-form" method="post">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <label for="switcher_input"
                            class="text-dark font-weight-bold mb-0">{{ translate('Check Status') }}</label>
                        <label class="switcher">
                            <input type="checkbox" id="switcher_input" class="switcher_input" name="status" value="1"
                                {{ json_decode($data['value'], true)['status'] == 1 ? 'checked' : '' }}>
