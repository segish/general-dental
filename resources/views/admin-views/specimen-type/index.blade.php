...
@section('title', translate('Add New Specimen Type'))
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                {{ \App\CentralLogics\translate('Add New Specimen Type') }}
            </h2>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.specimen_type.store') }}" method="post"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="{{ translate('Enter specimen type name') }}" required>
                                    </div>
