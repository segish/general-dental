...
@section('title', translate('laboratory request List'))
    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-3 align-items-center mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                ...
                {{ \App\CentralLogics\translate('laboratory_request_list') }}
            </h2>
            <span class="badge badge-soft-dark rounded-50 fs-14">{{ $laboratoryRequests->total() }}</span>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive datatable-custom">
                        <table
                            ...
                            <tbody id="set-rows">
                                @foreach ($laboratoryRequests as $key => $request)
                                    <tr>
                                        <td>{{ $laboratoryRequests->firstitem() + $key }}</td>
