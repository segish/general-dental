        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row justify-content-between align-items-center g-2 mb-3">
                    <div class="col-auto">
                        <h4 class="d-flex align-items-center gap-10 mb-0">
                            ...
                            {{ translate('Lab Technician Report') }}
                        </h4>
                    </div>
                </div>
                <div class="row g-2" id="order_stats">
                    <div class="col-sm-6">
                        <!-- Card -->
                        <a class="dashboard--card" href="{{ route('admin.testType.list') }}">
                            <h5 class="dashboard--card__subtitle">{{ \App\CentralLogics\translate('Test Types') }}</h5>
                            <h2 class="dashboard--card__title">{{ $testType_count }}</h2>
                            <img width="30"
                    ...
                    <div class="col-sm-6">
                        ...
                        <a class="dashboard--card" href="{{ route('admin.patient.list') }}">
                            <h5 class="dashboard--card__subtitle">{{ \App\CentralLogics\translate('Patients') }}</h5>
                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th>{{ \App\CentralLogics\translate('reg_number') }}</th>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            ...
                                            <a class="btn btn-outline-primary square-btn"
                                                href="{{ route('admin.patient.view', [$patient['id']]) }}">
                                            ...
                                            @if (auth('admin')->user()->can('user.delete'))
                                                <a class="btn btn-outline-danger square-btn" href="javascript:"
                                                    onclick="form_alert('patient-{{ $patient['id'] }}','{{ \App\CentralLogics\translate('Want to delete this patient ?') }}')"><i
