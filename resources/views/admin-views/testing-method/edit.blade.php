...
@section('title', translate('Update Testing Method'))
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{ asset(config('app.asset_path') . '/admin/img/icons/product.png') }}"
                    alt="">
                {{ \App\CentralLogics\translate('Update Testing Method') }}
            </h2>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.testing-method.update', $method->id) }}" method="post"
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="method_code" class="form-control"
                                            placeholder="{{ translate('Enter method code') }}" required maxlength="100"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="method_description">{{ \App\CentralLogics\translate('Description') }}</label>
                                        <textarea name="method_description" class="ckeditor form-control">{{ $method->method_description }}</textarea>
                                    </div>
                                </div>
                            </div>
