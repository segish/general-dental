...
@section('title', translate('update Doctor'))
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{ asset(config('app.asset_path') . '/admin/img/icons/product.png') }}"
                    alt="">
                {{ \App\CentralLogics\translate('update_doctor') }}
            </h2>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{ isset($doctor) ? route('admin.update', ['id' => $doctor->id]) : route('admin.store') }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="f_name"
                                                value="{{ isset($doctor) ? $doctor->admin->f_name : '' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="l_name"
                                                value="{{ isset($doctor) ? $doctor->admin->l_name : '' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone"
                                                value="{{ isset($doctor) ? $doctor->admin->phone : '' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email"
                                                value="{{ isset($doctor) ? $doctor->admin->email : '' }}"
                                                class="form-control"
                                            ...
                                            <select name="roles[]" class="form-control js-select2-custom" multiple required>
                                                @foreach ($roles as $role)
                                                    <option value="{{ $role->name }}"
                                                        {{ in_array($role->name, $doctor->admin->roles->pluck('name')->toArray()) ? 'selected' : '' }}>
                                                        {{ $role->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="experience"
                                                value="{{ isset($doctor) ? $doctor->experience : '' }}"
                                                class="form-control" placeholder="{{ translate('Ex : 23') }}" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="department_id" class="form-control js-select2-custom" required>
                                                ...
                                                @foreach ($departments as $dep)
                                                    <option value="{{ $dep->id }}"
                                                        {{ isset($doctor) && $doctor->department_id == $dep->id ? 'selected' : '' }}>
                                                        {{ $dep->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="input-label"
                                                for="specialization">{{ \App\CentralLogics\translate('specialization') }}</label>
                                            <input type="text" name="specialization"
                                                value="{{ isset($doctor) ? $doctor->specialization : '' }}"
                                                class="form-control" placeholder="{{ translate('') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <textarea name="about" class="ckeditor form-control">{{ isset($doctor) ? $doctor->about : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
