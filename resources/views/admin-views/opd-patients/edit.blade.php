...
@section('title', translate('update new department'))
        ...
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{ asset(config('app.asset_path') . '/admin/img/icons/product.png') }}"
                    alt="">
                {{ \App\CentralLogics\translate('update_department') }}
            </h2>
        </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="{{ translate('New Department') }}" required maxlength="100"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <textarea name="description" class="ckeditor form-control" name="about_us">{{ $department->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
