...
@section('title', translate('Update Laboratory Machine'))
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{ asset(config('app.asset_path') . '/admin/img/icons/product.png') }}"
                    alt="">
                {{ \App\CentralLogics\translate('Update Laboratory Machine') }}
            </h2>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.laboratory-machine.update', $machine->id) }}" method="post"
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="{{ translate('Enter name') }}" required maxlength="100"
                                            value="{{ $machine->name }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="model" class="form-control"
                                            placeholder="{{ translate('Enter model') }}" required maxlength="100"
                                            value="{{ $machine->model }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="serial_number" class="form-control"
                                            placeholder="{{ translate('Enter serial number') }}" required maxlength="100"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="manufacturer" class="form-control"
                                            placeholder="{{ translate('Enter manufacturer') }}" required maxlength="100"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="ckeditor form-control">{{ $machine->description }}</textarea>
                                    </div>
                                </div>
                            </div>
