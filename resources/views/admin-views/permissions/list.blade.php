...
@section('title', translate('permissions List'))
    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-3 align-items-center mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{ asset(config('app.asset_path') . '/admin/img/icons/permission.png') }}"
                    alt="">
                {{ \App\CentralLogics\translate('permissions_list') }}
            </h2>
            <span class="badge badge-soft-dark rounded-50 fs-14">{{ $permissions->total() }}</span>
        </div>
                    ...
                    <div class="px-20 py-3">
                        <div class="row gy-2 align-items-center">
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group">
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{ translate('Search by permission Name') }}" aria-label="Search"
                            ...
                            <div class="col-lg-8 col-sm-4 col-md-6 d-flex justify-content-sm-end">
                                <a href="{{ route('admin.permissions.add-new') }}" class="btn btn-primary">
                                    <i class="tio-add"></i>
                        ...
                        <table
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th>{{ \App\CentralLogics\translate('group') }}</th>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 justify-content-center">
                                                ...
                                                <a class="btn btn-outline-danger square-btn" href="javascript:"
                                                    onclick="form_alert('permission-{{ $permission['id'] }}','{{ \App\CentralLogics\translate('Want to delete this permission ?') }}')"><i
