...
@section('content')
    ...
    <div class="pb-2 px-2 px-sm-5 mx-xl-4">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Grofresh Software Installation" aria-valuenow="0"
        ...
        <div class="p-4 my-md-3 mx-xl-4 px-md-5">
            ...
            <div class="bg-light p-4 rounded mb-4">
                <div class="d-flex justify-content-between gap-1 align-items-center flex-wrap mb-4 pb-sm-3">
                    ...
                    <a href="https://docs.6amtech.com/docs-hexacom/admin-panel/install-on-server" target="_blank">Where to
                    ...
                    <div class="row gy-sm-5 g-4">
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/database-name.svg"
                                    alt="">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/database-password.svg"
                                    alt="">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/database-username.svg"
                                    alt="">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/database-hostname.svg"
                                    alt="">
