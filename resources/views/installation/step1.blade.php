...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>Hexacom Software Installation</h2>
        <h6 class="fw-normal">Please proceed step by step with proper data according to instructions</h6>
    </div>

    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Grofresh Software Installation" aria-valuenow="20"
            ...
            <div class="d-flex justify-content-end mb-2">
                <a href="https://docs.6amtech.com/docs-hexacom/intro" class="d-flex align-items-center gap-1"
                    ...
                    <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                        ...
                        <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/info.svg"
                            class="svg" alt="">
                    </span>
                </a>
            </div>
                    ...
                    <div class="row g-4 g-md-5">
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/php-version.svg"
                                    alt="">
                                <div class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                    ...
                                    @if ($phpVersion >= 8.0)
                                        <img width="20"
                                            src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/check.png"
                                            alt="">
                                    @else
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/curl-enabled.svg"
                                    alt="">
                                <div class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                    Curl Enabled
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/route-service.svg"
                                    alt="">
                                <div class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                    .env File Permission
                                    ...
                                    @else
                                        <span class="cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top"
                                            data-bs-custom-class="custom-tooltip" data-bs-html="true"
                                            data-bs-delay='{"hide":1000}' data-bs-title="Please change env permission">
                                            <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/info.svg"
                                                class="svg text-danger" alt="">
                                        </span>
                                    @endif
