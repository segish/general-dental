...
@section('content')
    ...
    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Grofresh Software Installation" aria-valuenow="90"
                                ...
                                <div class="from-group">
                                    <label for="phone" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/info2.svg"
                                                class="svg" alt="">
                                        </span>
                                    </label>
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        ...
                                        <div class="togglePassword">
                                            <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/eye.svg"
                                                alt="" class="svg eye">
                                            <img src="{{ asset(config('app.asset_path') . '/installation') }}/assets/img/svg-icons/eye-off.svg"
