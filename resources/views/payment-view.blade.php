...
<head>
    ...
    <link rel="stylesheet" href="{{ asset(config('app.asset_path') . '/admin') }}/css/bootstrap.css">
...
<body class="toolbar-enabled">
                                    ...
                                    <div class="card-body" style="height: 70px">
                                        <form action="{{ url('/pay-ssl') }}" method="POST" class="needs-validation"
                                            ...
                                            <button class="btn btn-block click-if-alone" type="submit">
                                                <img width="100"
                                                    src="{{ asset(config('app.asset_path') . '/admin/img/sslcomz.png') }}" />
                                            </button>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body" style="height: 70px">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="button"
                                            id="checkout-button">
                                            <img width="100"
                                                src="{{ asset(config('app.asset_path') . '/admin/img/stripe.png') }}" />
                                        </button>
                                ...
                                <div class="card">
                                    <div class="card-body" style="height: 70px">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="button"
                                            ...
                                            <img width="100"
                                                src="{{ asset(config('app.asset_path') . '/admin/img/paystack.png') }}" />
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body" style="height: 70px">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="button"
                                            ...
                                            <img width="100"
                                                src="{{ asset(config('app.asset_path') . '/admin/img/senangpay.png') }}" />
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body" style="height: 70px">
                                <button class="btn btn-block click-if-alone" id="bKash_button"
                                    ...
                                    <img width="100"
                                        src="{{ asset(config('app.asset_path') . '/admin/img/bkash.png') }}" />
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body pt-2" style="height: 70px">
                                <button class="btn btn-block click-if-alone"
                                    ...
                                    <img width="150"
                                        src="{{ asset(config('app.asset_path') . '/admin/img/MercadoPago_(Horizontal).svg') }}" />
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body pt-2" style="height: 70px">
                                <form method="POST" action="{{ route('flutterwave_pay') }}">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="submit">
                                        <img width="200"
                                            src="{{ asset(config('app.asset_path') . '/admin/img/fluterwave.png') }}" />
                                    </button>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body" style="height: 70px">
                                <form class="needs-validation" method="POST" id="payment-form-paymob"
                                    ...
                                    <button class="btn btn-block click-if-alone" type="submit">
                                        <img width="100"
                                            src="{{ asset(config('app.asset_path') . '/admin/img/paymob.png') }}" />
                                    </button>
                                </form>
                            </div>
                        </div>
    ...
    <!-- JS Front -->
    <script src="{{ asset(config('app.asset_path') . '/admin') }}/js/jquery.js"></script>
    <script src="{{ asset(config('app.asset_path') . '/admin') }}/js/bootstrap.js"></script>
