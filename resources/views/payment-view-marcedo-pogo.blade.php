...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset(config('app.asset_path') . '/mercado_pogo/css/index.css') }}">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script src="https://sdk.mercadopago.com/js/v2"></script>
    <!-- <script type="text/javascript" src="{{ asset(config('app.asset_path') . '/mercado_pogo/js/index.js') }}" defer></script> -->
</head>
            ...
            <div class="container__payment">
                ...
                <div class="form-payment">
                    <div class="products">
                        ...
                        <div class="total">{{ \App\CentralLogics\translate('amount_to_be_paid') }}<span
                                class="price">{{ $order->order_amount }}</span></div>
                    </div>
