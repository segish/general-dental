    ...
    <div class="card" style="padding: 10px 20px;">
        ...
        <div class="card-body">
            ...
            @if($appointment->status == 'confirmed')
                <p>We are pleased to confirm your appointment with Dr. {{ $doctor->admin->f_name }}.</p>
            @elseif($appointment->status == 'done')
                <p>We hope you had a successful appointment with Dr. {{ $doctor->admin->f_name }}.</p>
            @else
            ...
            @if($appointment->status == 'confirmed')
                <p>Your appointment is confirmed. Please be prepared for your appointment on the specified date and time.</p>
            @elseif($appointment->status == 'done')
                <p>We hope your appointment went well. If you have any follow-up questions, feel free to contact us.</p>
            @else
